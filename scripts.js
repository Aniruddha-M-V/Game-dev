...
class Shield {
    constructor(game) {
        ...
        this.frameX = 0
        this.maxFrame = 24
        this.image = document.querySelector('#shield')
        this.fps = 15
        this.timer = 0
...
class Particle {
    ...
    update(deltaTime) {
        ...
        if (this.y > this.game.height + this.size || this.x < -this.size || this.x > this.game.width + this.size) {
            this.markedForDeletion = true;
        }
...
class MoonFish extends Enemy {
    constructor(game) {
        ...
        this.height = 240
        this.y = Math.random() * (this.game.height * 0.95 - this.height) 
        this.image = document.querySelector('#moonfish') 
        this.frameY = 0
        this.lives = 10
        this.score = this.lives 
        this.speedX = Math.random() * -1.2 - 1.7
        this.type = 'moon'
    } 
}
...
class Stalker extends Enemy {
    constructor(game) {
        ...
        this.height = 123
        this.y = Math.random() * (this.game.height * 0.95 - this.height) 
        this.image = document.querySelector('#stalker') 
        this.frameY = 0
        this.lives = 5
        this.score = this.lives 
...
class Razorfin extends Enemy {
    constructor(game) {
        ...
        this.height = 149
        this.y = Math.random() * (this.game.height * 0.95 - this.height) 
        this.image = document.querySelector('#razorfin') 
        this.frameY = 0
        this.lives = 7
        this.score = this.lives 
        this.speedX = Math.random() * -1 - 1
...
if(this.game.score >= this.game.winningScore){
     ...
     message2 = 'The depths are conquered' 
        ...
        context.fillText('Press R to Play Again', this.game.width * 0.5, this.game.height * 0.5 + 80) 
    } 
    //ammo
...
if (enemy.x < this.width - enemy.width && this.checkCollision(this.player, enemy))
    { 
...
const canvasEl = document.querySelector('#canvas1');
